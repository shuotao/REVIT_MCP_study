(function () {
  ...
  // ============================================================
  var MEETUP_SIGNUP_URL = "https://forms.gle/yZRQnwtm6aL2EQhU9";
  ...
  var PAGE_META = {
    ...
    "reference/skills-index": { title: "Skills 索引（42）", desc: "編排層：何時觸發 / 什麼順序。" },
    "reference/domain-index": { title: "Domain 索引（67）", desc: "知識層：法規 / SOP / lessons。" },
    ...
    "skills-index": { title: "Skills 索引", desc: "42 個編排層 Skill。" },
    "domain-index": { title: "Domain 索引", desc: "67 個 SOP 知識。" },
