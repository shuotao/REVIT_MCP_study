...
| MCP Tools | 共用 77 個工具 | 共用 77 個工具 | 共用 77 個工具 |
...
| `MCP/Core/CommandExecutor.cs` | Central command dispatcher (77+ commands), largest file |
...
| `MCP-Server/src/tools/` | Tool definitions (77 tools, 分 16 個模組) |
