...
|---|---:|---|
| Runtime MCP tools | 92 | `registerRevitTools()` from `MCP-Server/src/tools/index.ts` |
| Domain SOP files | 43 | `domain/*.md` except `domain/README.md`, plus `domain/references/*.md` |
