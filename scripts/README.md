...
3. 如果改過安裝位置，請參考 README.zh-TW.md 的手動安裝方式

### Q: 找不到 RevitMCP.dll？
A:
1. 請先製作程式（見主 README.zh-TW.md 的「步驟 1」）
...
3. **嘗試手動安裝**
   - 參考 README.zh-TW.md 中的「方式 A - 選項 2」手動複製檔案
...
如有問題，請參考 README.zh-TW.md 或提交 Issue。
