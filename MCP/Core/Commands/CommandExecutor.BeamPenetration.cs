...
namespace RevitMCP.Core
{
    public partial class CommandExecutor
    {
        ...
        // ==================== 幾何/參數輔助方法（收編自鈺傑 rc 分支：BeamPenetration/AdvancedPenetration 超集）====================
        // PR #68 step1 slice omitted these leaf helpers though Scan/Analyze call them; ported verbatim so the partial compiles.
        ...
        // ==================== 清除舊有穿梁標註（收編自鈺傑 PR #68 CommandExecutor.cs；clear_previous_annotations dispatcher 用）====================
