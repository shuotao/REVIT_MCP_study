...
function getColor(val) {
    ...
    if (val === "2" || (val.includes("2") && val.includes("å°æ?"))) return COLOR_MAP["2HR"];
    if (val === "1" || (val.includes("1") && val.includes("å°æ?"))) return COLOR_MAP["1HR"];
    if (val.includes("??) || val === "0") return COLOR_MAP.NONE;
