...
| Item | Count | Source |
|---|---:|---|
| Runtime MCP tools | 108 | `registerRevitTools()` in `MCP-Server/src/tools/index.ts` |
| Domain SOP files | 58 | `domain/*.md` except `README.md`, plus `domain/references/*.md` |
| Claude skills | 27 | `.claude/skills/*/SKILL.md` |
